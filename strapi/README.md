...
3. **Part 3**: [Adding Postgresql to persist data in strapi and use of AWS S3 to save the media files.](https://www.kubekanvas.io/blog/building-and-deploying-a-modern-blog-platform-with-next-js-strapi-and-kubernetes-part-3-production-database-and-security)
